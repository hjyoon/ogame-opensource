...
- Go smoke covers route/assets, Fleetlogs, session/account, cookie isolation, report IDOR, input guards, URL/pic, feed, recovery, and `newredirect.php` (29 cases/1142 checks).
