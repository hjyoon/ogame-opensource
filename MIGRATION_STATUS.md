...
- Go smoke covers routes/assets, headers/cookies, GET no-op, Fleetlogs, session/acct, uni cookies, report IDOR, input, URL/pic, feed, recovery, and `newredirect.php` (31 cases/1171 checks).
