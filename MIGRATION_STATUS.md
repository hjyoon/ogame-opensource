...
- Go smoke covers routes/assets, hdrs/cookies, GET no-op, reg dup, admin ops/sim/audit/tools/perm/Uni/Fleetlogs/premium/vacation, sessions, report IDOR, input, URL/pic, feed, recovery, fleet guards, and `newredirect.php` (42 cases/1396 checks).
