...
- Go smoke covers route matrix, Fleetlogs, session/account security, cookie isolation, report IDOR, input hardening, URL/pic, feed, recovery, and `newredirect.php` (28 cases/1104 checks).
