...
- `8efc52a5` Apply legacy public universes layout.
- Milestone: legacy-visual public home/register/about/story/screenshots/rules/legal/universes and game overview pass current Go migration QA.
...
- Direct smoke after restart: `GET /universes`, `GET /unis.php`, bundle marker checks, and `docker ps` for `goapp` passed.
