...
- Go smoke covers routes/assets, auth, reg/recovery, acct/options, admin/Fleetlogs, premium/merchant/vacation/moon/phalanx, fleet, galaxy cost/IPM, buddy, report/msg send/lifecycle/retention/resources/input/feed, aliases (56 cases/1622 checks).
