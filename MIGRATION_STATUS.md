...
React/Bun + Go migration tracker. Keep under 4KB; split details as needed.
...
- Behavior baseline tracks behavior drift and 71 PHP/Go DB differential cases; phalanx and Jump Gate are included.
