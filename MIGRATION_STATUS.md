...
- Go smoke covers routes/assets, auth, reg/recovery, acct/options/localization, admin/Fleetlogs, premium/merchant/vacation/moon/phalanx, fleet, galaxy cost/IPM, buddy/social, report/msg lifecycle/resources/input/feed, aliases (60 cases/1723 checks).
