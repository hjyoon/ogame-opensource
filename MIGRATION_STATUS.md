...
- Overview covers `cp`, `lgn`, notices, unread/build row, header/menu/table parity, rename/delete rules, blockers, destroy markers, queue flush, stats/ranks, and active restore.
