...
- Go smoke covers routes/assets, auth/session, registration/recovery, account/options, admin ops/audit/perm/Uni/Fleetlogs, premium/merchant/vacation, fleet guards, report/input/url/feed, and legacy aliases (43 cases/1419 checks).
