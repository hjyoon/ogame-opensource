...
- Go smoke covers routes/assets, auth/session, reg/recovery, acct/options, admin ops/Fleetlogs, premium/merchant/vacation/moon/phalanx, fleet guards/templates, report/input/url/feed, aliases (46 cases/1466 checks).
