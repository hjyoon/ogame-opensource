...
- Go smoke covers routes/assets, auth, reg/recovery, acct/options, admin/Fleetlogs, premium/merchant/vacation/moon/phalanx, fleet, galaxy cost/IPM, buddy, report/msg lifecycle/retention/resources/input/feed, aliases (53 cases/1588 checks).
