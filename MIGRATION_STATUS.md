...
- Overview planet rename uses the legacy validation order and no-op rules; abandon opens password confirmation.
...
- Port overview delete execution, password checks, fleet blockers, stat/rank side effects, and remaining legacy actions.
