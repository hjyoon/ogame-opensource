...
- Go smoke covers routes/assets, headers/cookies, GET no-op, reg dup, Fleetlogs, session/acct, uni cookies, report IDOR, input, URL/pic, feed, recovery, and `newredirect.php` (32 cases/1181 checks).
