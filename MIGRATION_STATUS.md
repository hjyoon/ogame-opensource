...
- Go smoke covers routes/assets, auth, reg/recovery, acct/options, admin/Fleetlogs, premium/merchant/vacation/moon/phalanx, fleet, galaxy cost/IPM, buddy, report/msg send/lifecycle/retention/resources/input/feed, aliases (55 cases/1611 checks).
