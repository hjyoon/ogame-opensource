...
- Jump Gate, pranger, maintenance, Mods actions, and Logins/Browse audit data are migrated.
...
- Absolute legacy coverage target: 90%; current estimate: 82% in [COVERAGE-absolute.md](./testing/e2e/COVERAGE-absolute.md).
