...
- Go smoke covers routes/assets, auth/session, reg/recovery, acct/options, admin ops/Fleetlogs, premium/merchant/vacation/moon/phalanx, fleet guards/templates, galaxy-cost, report/input/url/feed, aliases (47 cases/1478 checks).
