...
- Jump Gate, pranger, maintenance, Mods, Logins/Browse audit, Loca compare, and Bots list/stop are migrated.
...
- Absolute legacy coverage target: 90%; current estimate: 84% in [COVERAGE-absolute.md](./testing/e2e/COVERAGE-absolute.md).
