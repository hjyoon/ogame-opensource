...
- Jump Gate has natural/legacy `sprungtor`; pranger, maintenance, and Mods state actions are migrated.
...
- Absolute legacy coverage target: 90%; current estimate: 81% in [COVERAGE-absolute.md](./testing/e2e/COVERAGE-absolute.md).
