...
- Overview covers `cp`, `lgn`, notices, unread/build/incoming/missile/fleet pseudo-events, chrome parity, rename/delete, blockers, destroy markers, queue flush, stats/ranks, and active restore.
