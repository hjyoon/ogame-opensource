...
- Jump Gate, pranger, maintenance, Mods, Logins/Browse audit, and Loca compare are migrated.
...
- Absolute legacy coverage target: 90%; current estimate: 83% in [COVERAGE-absolute.md](./testing/e2e/COVERAGE-absolute.md).
