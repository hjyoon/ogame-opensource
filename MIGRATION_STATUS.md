...
- Overview covers `cp`, `lgn`, notices, unread/build/event rows, header/menu/table parity, rename/delete rules, blockers, destroy markers, queue flush, stats/ranks, and active restore.
...
- Port incoming/ACS overview events.
