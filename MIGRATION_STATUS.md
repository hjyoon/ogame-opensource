...
- Behavior baseline tracks drift and 327 PHP/Go differential cases; Admin evidence is tracked in [COVERAGE-admin-differential.md](./testing/e2e/COVERAGE-admin-differential.md).
