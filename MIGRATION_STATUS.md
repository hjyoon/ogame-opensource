...
- Go smoke covers routes/assets, auth, reg/recovery, acct/options, admin/Fleetlogs, premium/merchant/vacation/moon/phalanx, fleet, galaxy cost/IPM, buddy, report/msg retention/resources/input/feed, aliases (52 cases/1578 checks).
