...
- Go smoke covers route matrix, Fleetlogs, session/account security, cross-universe cookies, report IDOR, URL/pic, feed, password recovery, and `newredirect.php` (27 cases/1090 checks).
