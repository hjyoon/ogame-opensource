...
- Jump Gate has natural/legacy `sprungtor`; pranger and maintenance have raw legacy HTML compatibility.
...
- Absolute legacy coverage target: 90%; current estimate: 80% in [COVERAGE-absolute.md](./testing/e2e/COVERAGE-absolute.md).
