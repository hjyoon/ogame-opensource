...
- Overview covers `cp`, `lgn`, notices, unread/build/incoming event rows, header/menu/table parity, rename/delete rules, blockers, destroy markers, queue flush, stats/ranks, and active restore.
...
- Port ACS/missile overview events.
