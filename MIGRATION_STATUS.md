...
- Buildings layout matches legacy row spacing/image/action geometry; add/remove writes legacy queues.
...
- Port building destroy/finish, research start/cancel, shipyard/defense orders, fleet actions, galaxy quick actions, reports/messages/alliance/admin/options/recovery/deletion/vacation/bans/permissions.
