...
- Go smoke covers route/assets, headers/cookies, Fleetlogs, session/account, cookie isolation, report IDOR, input guards, URL/pic, feed, recovery, and `newredirect.php` (30 cases/1157 checks).
