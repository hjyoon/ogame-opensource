...
- Go smoke covers routes/assets, headers/cookies, GET no-op, reg dup, admin ops/sim/audit/tools/Fleetlogs, sessions, report IDOR, input, URL/pic, feed, recovery, fleet guards, and `newredirect.php` (38 cases/1327 checks).
