...
- Go smoke covers routes/assets, hdrs/cookies, GET no-op, reg dup, admin ops/sim/audit/tools/perm/Uni/Fleetlogs/premium, sessions, report IDOR, input, URL/pic, feed, recovery, fleet guards, and `newredirect.php` (41 cases/1378 checks).
