...
- Empire ports the Commander-gated `imperium` table plus legacy GET build add/destroy/remove shortcuts.
...
- Port Empire queued-row rendering, fleet dispatch/ACS, galaxy instant actions, alliance/admin/recovery/bans/permissions, and deeper options mutations.
