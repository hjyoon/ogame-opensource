export function LegacyPublicLegal() {
  return (
    <main className="legacy-legal-page">
      <article className="legacy-legal-document">
        <section>
          <p>
            <strong>
              <u>Reasons for creating the project</u>
            </strong>
          </p>
          <p>A list of reasons why the Redesign is not suitable for normal play:</p>
          <ul>
          ...
          <p>As a consequence, it is lost:</p>
          <ul>
            <li>
              Ability to adequately manage fleets. Now to lift a fleet in 3-4 seconds or to simultaneously slow down 3-4
              ACS attacks is an almost unrealistic task.
            </li>
            <li>
              With the patched activity, a whole layer of the game is gone - the so-called "Ninja" attacks, where a
              player updates the Overview and suddenly catches an attacker with a Gate.
            </li>
        ...
        <section>
          <p>
            <strong>
              <u>Differences to the original</u>
            </strong>
          </p>
          <p>Which is not going to happen in this project:</p>
          <ul>
          ...
          <p>Fixed bugs of the original version 0.84:</p>
          <ul>
        ...
        <section>
          ...
          <p>
            - GitHub:{" "}
            <a href="https://github.com/ogamespec/ogame-opensource" rel="noreferrer" target="_blank">
              https://github.com/ogamespec/ogame-opensource
            </a>
            <br />- Discord: https://discord.gg/xpCV3McAj2
          </p>
        </section>

        <p>BIG MONEY MAKES YOU DEVIL.</p>
      </article>
    </main>
  );
}
