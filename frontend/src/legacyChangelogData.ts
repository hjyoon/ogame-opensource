...
export const legacyChangelogRows: LegacyChangelogRow[] = [
  ...
  {
    "version": "0.330a",
    "description": "- The death star can fly<br />\n- Vacation mode can be deactivated"
  },
  {
    "version": "0.327a",
    "description": "- Defense debris no longer falls into debris fields<br />\n- Spy probes no longer have weapons or defenses (1% of old values)<br />\n- Ability to save recyclers"
  },
  {
    "version": "0.326a",
    "description": "- Canceling vacation mode"
  },
  {
    "version": "0.325apl1",
    "description": "- Fixed an error with displaying 1000<br />\n- Message with empty name<br />\n- Recycler bug (it is now possible to transport more than 8M resources)<br />\n- New error message when changing alliance name"
  },
  {
    "version": "0.325a",
    "description": "- Implemented script detectors"
  },
  {
    "version": "0.324a",
    "description": "- Fixed a bug with planet jumping (failed)"
  },
  {
    "version": "0.323a",
    "description": "- Fixed display of zero level of storages<br />\n- Expanded database for ship types<br />\n- Fixed an error in the display of ship construction"
  },
  {
    "version": "0.322a",
    "description": "- Messages to individual alliance members can be sent from the alliance menu"
  },
  {
    "version": "0.321apl3",
    "description": "- Alliance search has been eliminated from the search function<br />\n- The search function is tailored to alliances<br />\n- The head of an alliance has only the rights given to him by his rank."
  },
  {
    "version": "0.321apl1",
    "description": "- Fixed several bugs in ACS"
  },
  {
    "version": "0.321a",
    "description": "- Small Alliance System"
  },
  {
    "version": "0.312apl10",
    "description": "- Allowed space in alliance abbreviation"
  },
  {
    "version": "0.312apl9",
    "description": "- Partially fixed a bug that incorrectly displayed the level of construction and research.<br />\n- Cannot send to coordinate <0"
  },
  {
    "version": "0.312apl8",
    "description": "- Correcting an error in production display"
  },
  {
    "version": "0.312apl7",
    "description": "- Fixing a bug in the shipyard<br />\n- Fixes bug when calculating free fields after construction is finished"
  },
  {
    "version": "0.312apl6",
    "description": "- Works return after sending spies<br />\n- Thanks to dragoscan in the galaxy works return"
  },
  {
    "version": "0.312apl5",
    "description": "- Deleted text about the cost of fleet maintenance"
  },
  {
    "version": "0.312apl4",
    "description": "- Link to CHANGELOG<br />\n- Clearing the cache when building structures<br />\n- Building a nanite factory is not possible when building ships"
  },
  {
    "version": "0.312apl3",
    "description": "- Corrects a shipyard bug where negative time was shown<br />\n- Adding a link to the home page on exit.<br />\n- Fixed the shield dome bug. Now they can only be built once."
  },
  {
    "version": "0.312apl2",
    "description": "- Fixing special characters"
  }
];
