...
func New(deps Dependencies) http.Handler {
	...
	mux.HandleFunc("/game/reg/check_registration.php", a.handleLegacyRegistrationCheck)
	mux.HandleFunc("/game/reg/errorpage.php", getOnly(a.handleLegacyLoginErrorPage))
	mux.HandleFunc("/game/reg/login2.php", a.handleLegacyLogin)
	mux.HandleFunc("/game/reg/login.php", getOnly(a.handleLegacyLoginForm))
	...
	mux.HandleFunc("/game/css/", getOnly(a.handleLegacyGameStaticAsset))
	mux.HandleFunc("/game/img/", getOnly(a.handleLegacyGameStaticAsset))
	...
	mux.HandleFunc("/game/feed/show.php", a.handleGameFeedShow)
	mux.HandleFunc("/game/feed/viewitem.php", a.handleGameFeedItem)
