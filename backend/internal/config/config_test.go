...
func TestLoadDefaults(t *testing.T) {
	...
	if cfg.PublicUniverses != "" || cfg.MCPStaticTokens != "" || cfg.MCPOAuthRedirectURIs != "" || cfg.SMTPEnabled || cfg.SMTPAddr != "localhost:1025" || cfg.SMTPFrom != "OGame <noreply@localhost>" {
...
func TestLoadEnvOverrides(t *testing.T) {
	...
	if cfg.PublicUniverses != `[{"number":1}]` || cfg.MCPStaticTokens != "token:42:mcp:read" || cfg.MCPOAuthRedirectURIs != "https://client.example/callback" || !cfg.SMTPEnabled || cfg.SMTPAddr != "mailhog:1025" || cfg.SMTPFrom != "No Reply <no-reply@example.local>" {
