...
var buildingCatalog = []buildingSpec{
	...
	{BuildingCrystalMine, "Crystal Mine", "Crystal mines supply the main resource used to produce electronic circuits and from certain alloy compounds.", BuildingCost{Metal: 48, Crystal: 24}, 1.6, nil, planetOnly},
	{BuildingDeuteriumSynth, "Deuterium Synthesizer", "Deuterium synthesizers extract the small amount of deuterium in deep water.", BuildingCost{Metal: 225, Crystal: 75}, 1.5, nil, planetOnly},
	{BuildingSolarPlant, "Solar Plant", "Solar plants absorb energy from solar radiation. All mines need energy to operate.", BuildingCost{Metal: 75, Crystal: 30}, 1.5, nil, planetOnly},
	...
	{BuildingRoboticsFactory, "Robotics Factory", "Robotic factories provide construction robots to aid in the construction of buildings.", BuildingCost{Metal: 400, Crystal: 120, Deuterium: 200}, 2, nil, planetAndMoon},
	...
	{BuildingMetalStorage, "Metal Storage", "Storage for raw metal ore before it is processed.", BuildingCost{Metal: 2000}, 2, nil, planetAndMoon},
	{BuildingCrystalStorage, "Crystal Storage", "Storage for unprocessed raw crystal.", BuildingCost{Metal: 2000, Crystal: 1000}, 2, nil, planetAndMoon},
	{BuildingDeuteriumTank, "Deuterium Tank", "Huge tanks store newly extracted deuterium.", BuildingCost{Metal: 2000, Crystal: 2000}, 2, nil, planetAndMoon},
	...
	{BuildingTerraformer, "Terraformer", "The terraformer increases the usable area on a planet.", BuildingCost{Crystal: 50000, Deuterium: 100000, Energy: 1000}, 2, map[int]int{BuildingNaniteFactory: 1, ResearchEnergy: 12}, planetOnly},
	{BuildingAllianceDepot, "Alliance Depot", "The alliance depot supplies fuel to friendly fleets in orbit.", BuildingCost{Metal: 20000, Crystal: 40000}, 2, nil, planetOnly},
	{BuildingLunarBase, "Lunar Base", "A moon has no atmosphere, so a lunar base must be built before settlement can begin.", BuildingCost{Metal: 20000, Crystal: 40000, Deuterium: 20000}, 2, nil, moonOnly},
	{BuildingSensorPhalanx, "Sensor Phalanx", "The sensor phalanx scans fleet movements from the moon.", BuildingCost{Metal: 20000, Crystal: 40000, Deuterium: 20000}, 2, map[int]int{BuildingLunarBase: 1}, moonOnly},
	{BuildingJumpGate, "Jump Gate", "Jump gates can send fleets between moons without loss of time.", BuildingCost{Metal: 2000000, Crystal: 4000000, Deuterium: 2000000}, 2, map[int]int{BuildingLunarBase: 1}, moonOnly},
	{BuildingMissileSilo, "Missile Silo", "Missile silos store anti-ballistic and interplanetary missiles.", BuildingCost{Metal: 20000, Crystal: 20000, Deuterium: 1000}, 2, map[int]int{BuildingShipyard: 1}, planetOnly},
}
