...
| `GET/POST` | `/api/game/admin` | Admin console by `mode`, audit/localization rows |
...
| `GET/HEAD/POST` | `/game/index.php` | Legacy game entry, BotEdit, Mods, Logins/Loca POST, `sprungtor`, `pranger` |
