...
| Admin/ops tools | 15 | 14 | admin pages, bans, audit Logins/Browse, Loca compare, Bots stop/list, pranger; some tools remain shallow |
...
| **Total** | **100** | **84** | conservative estimate |
...
- Admin Bots now lists queued AI owners, renders home planet links, and supports legacy/API stop actions.

## Work To Reach 90%

Prioritize gaps that add product coverage, not just more screenshots:

1. Deepen admin/ops behavior: AddBot/simulator variants, destructive safety edges.
