...
- Behavior audit freezes 463 core request inputs, 162 action values, 19 queue constants, 349 SQL mutation sites, and 149 navigation handlers; resource and build/research/shipyard queue lifecycles have DB differential evidence.
