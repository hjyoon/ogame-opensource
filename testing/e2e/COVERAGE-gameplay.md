...
- ACS attack/hold, 30% slowdown, union join/recall, held-fleet defense/writeback, report recipients, and return.
...
- Interplanetary missiles, anti-ballistic missiles, silo capacity, all eight primary defense targets, ordered spillover, and defense destruction.
