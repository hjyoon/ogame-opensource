...
try {
  ...
  const researchMutationPreview = startResearchDryRunBody.result?.structuredContent?.researchMutation;
  const requestedResearchOption = (researchOptionsToolBody.result?.structuredContent?.researchOptions?.items ?? []).find((item) => Number(item?.id ?? 0) === 106);
  ...
  cases.push(finalize({
    ...
    checks: [
      ...
      check(enqueueShipyardOrderDryRunBody.result?.structuredContent?.enqueueShipyardOrder?.issue ? enqueueShipyardOrderDryRunBody.result?.structuredContent?.enqueueShipyardOrder?.status === undefined && enqueueShipyardOrderDryRunBody.result?.structuredContent?.enqueueShipyardOrder?.finishesAt === undefined : Number(enqueueShipyardOrderDryRunBody.result?.structuredContent?.enqueueShipyardOrder?.durationSeconds ?? 0) > 0 && Number(enqueueShipyardOrderDryRunBody.result?.structuredContent?.enqueueShipyardOrder?.totalDurationSeconds ?? 0) > 0 && Number(enqueueShipyardOrderDryRunBody.result?.structuredContent?.enqueueShipyardOrder?.finishesAt ?? 0) > Number(enqueueShipyardOrderDryRunBody.result?.structuredContent?.enqueueShipyardOrder?.startsAt ?? 0) && Number(enqueueShipyardOrderDryRunBody.result?.structuredContent?.enqueueShipyardOrder?.remainingSeconds ?? 0) > 0 && enqueueShipyardOrderDryRunBody.result?.structuredContent?.enqueueShipyardOrder?.status === "preview", "enqueue_shipyard_order returns positive projected timing only when the order is valid", enqueueShipyardOrderDryRunBody.result ?? {}),
      ...
      check(Number(mutateBuildingDryRunBody.result?.structuredContent?.buildingMutation?.timing?.durationSeconds ?? 0) > 0 && Number(mutateBuildingDryRunBody.result?.structuredContent?.buildingMutation?.timing?.finishesAt ?? 0) > Number(mutateBuildingDryRunBody.result?.structuredContent?.buildingMutation?.timing?.startsAt ?? 0) && Number(mutateBuildingDryRunBody.result?.structuredContent?.buildingMutation?.timing?.remainingSeconds ?? 0) > 0 && mutateBuildingDryRunBody.result?.structuredContent?.buildingMutation?.timing?.status === "preview", "mutate_building dry-run returns explicit non-zero projected timing", mutateBuildingDryRunBody.result ?? {}),
      ...
      check(requestedResearchOption ? Number(researchMutationPreview?.timing?.durationSeconds ?? 0) > 0 && Number(researchMutationPreview?.timing?.finishesAt ?? 0) > Number(researchMutationPreview?.timing?.startsAt ?? 0) && Number(researchMutationPreview?.timing?.remainingSeconds ?? 0) > 0 && researchMutationPreview?.timing?.status === "preview" : researchMutationPreview?.timing === undefined, "start_research returns positive projected timing only when the research option is available", startResearchDryRunBody.result ?? {}),
