...
const artifacts = [
  ...
  { name: "go/PHP Graviton differential", path: ".tmp/golang-graviton-differential.json" },
  ...
  { name: "go/PHP Terraformer differential", path: ".tmp/golang-terraformer-differential.json" },
